...
export interface components {
    schemas: {
        ...
        SendMessageDto: {
            ...
            /**
             * @description Text body or optional image/audio caption. Provide text or at least one attachment.
             * @example Hello! Are you free to chat?
             */
            text?: string;
            /**
             * @description Ordered ready message_attachment media IDs owned by the sender. Image messages accept up to ten images; audio messages accept exactly one audio asset. Images and audio cannot be mixed.
             * @example [
        ...
        MessageResponseDto: {
            ...
            /** @example Hello! Are you free to chat? */
            text: string | null;
            attachments: (components["schemas"]["MessageAttachmentResponseDto"] | components["schemas"]["AudioMessageAttachmentResponseDto"])[];
            /** Format: date-time */
            createdAt: string;
        };
        MessagePageInfoDto: {
        ...
        CreateMediaUploadDto: {
             ...
             * @enum {string}
             */
            contentType: "image/jpeg" | "image/png" | "image/webp" | "audio/aac" | "audio/mp4" | "audio/m4a" | "audio/x-m4a" | "audio/mpeg" | "audio/ogg" | "audio/wav" | "audio/x-wav";
            /**
             * @description Declared input size in bytes. Images are limited to 5 MiB and audio recordings to 20 MiB before configured limits are applied.
             * @example 245000
             */
            sizeBytes: number;
            /**
             * @description Optional client-calculated SHA-256 used to strengthen idempotency. Cloudinary metadata does not independently verify it.
...
export interface operations {
    ...
    send: {
        ...
        responses: {
            ...
            /** @description The client message ID was reused with different data or an attachment is unavailable. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    create: {
        ...
        responses: {
            ...
            /** @description Media uploads are disabled, or the audio upload preset is not configured. */
            503: {
                headers: {
                    [name: string]: unknown;
                };
